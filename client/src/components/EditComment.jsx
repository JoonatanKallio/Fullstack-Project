...
function EditComment() {
    ...
    if (comment) { // Returns the editing elements if comment exists
        return (
            <Box sx={{
                width: "100%", display: "flex", alignItems: "center", justifyContent: "center", flexDirection: "column", marginTop: "10px", gap: "20px",
            }}
            >
                <Typography sx={{ fontSize: "32px" }}>Edit your comment</Typography>
                <TextField className="comment-editing-box" defaultValue={comment.content} onChange={(e) => setText(e.target.value)} />
